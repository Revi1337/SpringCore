...
//        DiscountPolicy bean = ac.getBean(DiscountPolicy.class);
    ...
    public void findBeanByParentTypeSolvingDuplicate() {
    ...
    public void findAllBeanByParent() {
    ...
    @Test
    @DisplayName(value = "부모 타입으로 모두 조회하기 - Object 클래스")
    public void findBeanByObjectClass() {
